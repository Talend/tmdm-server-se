...
public class DataRecordEmptyLabelXmlWriter implements DataRecordWriter {
    ...
    public DataRecordEmptyLabelXmlWriter() {
        rootElementName = null;
        includeMetadata = false;
    }

    public DataRecordEmptyLabelXmlWriter(boolean includeMetadata) {
        rootElementName = null;
        this.includeMetadata = includeMetadata;
    }

    public DataRecordEmptyLabelXmlWriter(String rootElementName) {
        this.rootElementName = rootElementName;
        includeMetadata = false;
    }

    public DataRecordEmptyLabelXmlWriter(ComplexTypeMetadata type) {
        this.type = type;
    ...
    class FieldPrinter extends DefaultMetadataVisitor<Void> {
        ...
        public Void visit(ReferenceFieldMetadata referenceField) {
            ...
            try {
                ...
                boolean isExixedInValueList = record.isExixedInValueList(referenceField);
                if (value != null) {
        ...
        public Void visit(ContainedTypeFieldMetadata containedField) {
            ...
            try {
                if (!containedField.isMany()) {
                    boolean isExixedInValueList = record.isExixedInValueList(containedField);
        ...
        public Void visit(SimpleTypeFieldMetadata simpleField) {
            ...
            try {
                boolean isExixedInValueList = record.isExixedInValueList(simpleField);
        ...
        public Void visit(EnumerationFieldMetadata enumField) {
            ...
            try {
                boolean isExixedInValueList = record.isExixedInValueList(enumField);
