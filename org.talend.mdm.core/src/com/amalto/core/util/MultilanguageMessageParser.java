...
/**
 * Please note that this class is duplicated with class org.talend.mdm.webapp.base.client.util.MultilanguageMessageParser)
 * They should be consistent during change.
 */
