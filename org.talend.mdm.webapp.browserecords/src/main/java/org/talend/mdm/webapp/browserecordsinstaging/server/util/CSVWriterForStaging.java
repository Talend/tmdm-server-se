...
public class CSVWriterForStaging extends CSVWriter {

    public CSVWriterForStaging(String concept, String viewPk, List<String> idsList, String[] headerArray, String[] xpathArray,
    ...
    public String generateFileName(String name) {
        return name + Constants.STAGING_SUFFIX_NAME + "." + Constants.FILE_TYPE_CSV; //$NON-NLS-1$
    }
}
